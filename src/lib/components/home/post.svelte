...
<a
	...
	class={'relative h-4/5 dark:bg-primary bg-primaryLight rounded-md border dark:border-secondary border-secondaryLight p-6 flex flex-col justify-center gap-6 break-words group cursor-pointer'}
>
